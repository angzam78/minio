...
```sh
GO111MODULE=on go get github.com/angzam78/minio
```
...
![Screenshot](https://github.com/angzam78/minio/blob/master/docs/screenshots/minio-browser.png?raw=true)
...
Please follow MinIO [Contributor's Guide](https://github.com/angzam78/minio/blob/master/CONTRIBUTING.md)

## License
Use of MinIO is governed by the Apache 2.0 License found at [LICENSE](https://github.com/angzam78/minio/blob/master/LICENSE).
