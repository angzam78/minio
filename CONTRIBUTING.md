...
Fork [MinIO upstream](https://github.com/angzam78/minio/fork) source repository to your own personal repository. Copy the URL of your MinIO fork (you will need it for the `git clone` command below).

```sh
$ git clone https://github.com/angzam78/minio
$ go install -v
$ ls /go/bin/minio
```
...
```sh
$ cd minio
$ git remote add upstream https://github.com/angzam78/minio
$ git fetch upstream
