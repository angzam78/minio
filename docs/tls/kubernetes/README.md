...
For testing purposes, here is [how to create self-signed certificates](https://github.com/angzam78/minio/tree/master/docs/tls#3-generate-self-signed-certificates).
